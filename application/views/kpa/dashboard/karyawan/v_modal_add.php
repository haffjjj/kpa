   ...
   <div role="form" class="form-inline" role="form" id="form_load_content_id">
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo base_url(); ?>Karyawan/add_penyerapan" method="POST">
        ...
        <input type="hidden" name="triwulan" value="<?php echo $triwulan ?>" class="form-control">
        <input type="hidden" name="tahun" value="<?php echo $tahun ?>" class="form-control">
        <p>Nama Kegiatan</p>
        <input type="text" name="nama_kegiatan" class="form-control" size="26">
        <p>Jenis Kegiatan</p>
        <input type="text" name="jenis_kegiatan" class="form-control" size="26">
        <p>Tanggal Kegiatan</p>
        <input type="date" name="tanggal" class="form-control" id="bulan">
        <p>Status</p>
        <input type="text" name="status" class="form-control" size="26">
        <p>Jumlah</p>
        <input type="text" name="jumlah" class="form-control" size="26">
        <br>
